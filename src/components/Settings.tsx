      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">IP 检测设置</h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">新域名的默认更新间隔 (30-86400 秒)</p>
              </div>
          ...
          {/* 日志设置 */}
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">日志设置</h3>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-3">
                  <div className="text-sm font-medium text-gray-900 dark:text-white">启用桌面通知</div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  {settings.theme === 'auto' && '白天(6:00-18:00)使用浅色,夜间使用深色'}
                  {settings.theme === 'light' && '始终使用浅色主题'}
                  {settings.theme === 'dark' && '始终使用深色主题'}
                </p>
              </div>
          ...
          <div className="flex justify-end gap-3">
            <button
              ...
              disabled={loading}
              className="px-4 py-2 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              重置
            </button>
            <button
          ...
          <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">关于 DDNS 工具</h3>
